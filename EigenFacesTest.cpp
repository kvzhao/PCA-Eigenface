...
int main (int argc, char *argv[]) {
	...
	bool isVerbose=false, doShow=false;
	char c;
	...
	Mat teImg = imread(teFaceFiles[0], 0);
    /* is here a bug? trFaceFiles -> teFaceFiles */
	...
	myFaceRecognizer fr(trImgVectors, trImageIDToSubjectIDMap, 30);
	...
	if(doShow)
	{
        ...
        Mat oEigenvalues = fr.getEigenvalues();
